#pragma checksum "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "956f967166e35dbcbdc7888526b1fd46879b3970"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"956f967166e35dbcbdc7888526b1fd46879b3970", @"/Views/Home/Advertisements.cshtml")]
...
#nullable disable
            WriteLiteral(@"'.length > 0;
                if(availableToken){
                    ...
                    let role = '");
#nullable restore
#line 29 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                    ...
                    hubConnection.on('SendStudent', function (message, name) {
                        if (role === 'employer') {
                            $('.panel-body').append('<div class=""row msg_container base_receive"">' +
                                ...
                                '<time datetime=""");
#nullable restore
#line 40 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                            Write(DateTime.Now);
...
#nullable disable
            WriteLiteral(@""">' + name + '</time>' +
                            ...
                            $('.panel-body').append('<div class=""row msg_container base_sent"">'+
                                    ...
                                    '<time datetime=""");
#nullable restore
#line 50 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                Write(DateTime.Now);
                    ...
                    hubConnection.on('SendEmployer', function (message, name) {
                        if (role === 'employer') {
                            $('.panel-body').append('<div class=""row msg_container base_sent"">' +
                                ...
                                '<time datetime=""");
#nullable restore
#line 66 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                            Write(DateTime.Now);
...
#nullable disable
            WriteLiteral(@""">' + name + '</time>' +
                            ...
                            $('.panel-body').append('<div class=""row msg_container base_receive"">'+
                                 ...
                                 '</div>'+
                                 '<div class=""col-md-10 col-xs-10"">'+
                                 '<div class=""messages msg_");
            WriteLiteral("receive\">\'+\r\n                                 \'<p>\' + message + \'</p>\'+\r\n                                 \'<time datetime=\"");
#nullable restore
#line 82 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                             Write(DateTime.Now);
                    ...
                    hubConnection.on('SendResume', function (url, name) {
                        $.get(
                            ...
                            $('.panel-body').append('<div class=""row msg_container base_sent"">' +
                                ...
                                '<time datetime=""");
#nullable restore
#line 99 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                            Write(DateTime.Now);
...
#nullable disable
            WriteLiteral(@""">' + name + '</time>' +
                            ...
                            $('.panel-body').append('<div class=""row msg_container base_receive"">'+
                                 ...
                                 '<div class=""col-md-10 col-xs-10"">'+
                                 '<div class=""messa");
            WriteLiteral(@"ges msg_receive"">'+
                                '<p><form action=""' + url + '"" method=""post"" enctype=""multipart/form-data"">' +
                                '<button type=""submit"" class=""btn btn-outline-primary""> ' + data.name + '</button></form></p>'+
                                 '<time datetime=""");
#nullable restore
#line 116 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                             Write(DateTime.Now);
...
#nullable disable
            WriteLiteral(@""">' + name + '</time>'+
                    ...
                    let resume = null;
                    let resumePath = '/users/students/id=");
#nullable restore
#line 124 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                    Write(id);
...
#nullable disable
            WriteLiteral("/resume\';\r\n                if (\'");
#nullable restore
#line 125 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                Write(id);
...
#nullable disable
          ...
          ");
            WriteLiteral("                  $.ajax({\r\n                                method: \"PUT\",\r\n                                headers: {\r\n                                    \'Authorization\': \'Bearer ");
#nullable restore
#line 222 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                        Write(token);
...
#nullable disable
            ...
            WriteLiteral(";\r\n                            $.ajax({\r\n                                method: \"PUT\",\r\n                                headers: {\r\n                                    \'Authorization\': \'Bearer ");
#nullable restore
#line 246 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                        Write(token);
...
#nullable restore
#line 270 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                        Write(token);
...
#nullable disable
    ...
    ");
            WriteLiteral("                $(\'.chat_btn\').click(function () {\r\n                        let message = $(\'.chat_input\').val();\r\n                        if (role === \'employer\') {\r\n                            hubConnection.invoke(\'SendEmployer\', message, \'");
#nullable restore
#line 295 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                                      Write(HttpContextAccessor.HttpContext.Session.GetString("Name"));

#line default
#line hidden
#nullable disable
            WriteLiteral("\');\r\n                        } else {\r\n                            hubConnection.invoke(\'SendStudent\', message, \'");
#nullable restore
#line 297 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                                     Write(HttpContextAccessor.HttpContext.Session.GetString("Name"));
            ...
            WriteLiteral(@"');
                    ...
                    $('.resume_btn').click(function () {
                            if (resume === null) {
                                ...
                                hubConnection.invoke(""SendResume"", resumePath, '");
#nullable restore
#line 306 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                                           Write(HttpContextAccessor.HttpContext.Session.GetString("Name"));

#line default
#line hidden
#nullable disable
            WriteLiteral("\');\r\n                            }\r\n                    });\r\n                hubConnection.start().then(function () {\r\n                     hubConnection.invoke(\"CreateGroup\", adv.employerId, \'");
#nullable restore
#line 310 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                                     Write(id);
...
#nullable restore
#line 318 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
...
#nullable disable
            WriteLiteral("                        <script>\r\n                            $.get(\r\n                                \'");
#nullable restore
#line 326 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                            Write(favpath);
...
#nullable restore
#line 329 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                                                             Write(favpath);
...
");
#nullable restore
#line 336 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                    }
...
#nullable disable
 ...
 ");
            WriteLiteral(@"                   <div class=""col-md-3 row chat-window col-xs-5"" id=""chat_window_1"">
...
");
#nullable restore
#line 368 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
...
#line hidden
#nullable disable
            WriteLiteral("                                                   <button class=\"btn btn-success resume_btn\">Send resume</button>\r\n                                                   <span class=\"badge badge-danger chat-error\"></span>\r\n");
#nullable restore
#line 373 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
                                                }
...
#nullable disable
            WriteLiteral("                                        </span>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n     </div>\r\n");
#nullable restore
#line 382 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
    }
    else
    {
                ...
                <form method=""post"" id=""filter-ads-form"">
                    <div class=""form-row"">
                        ...
                        <select class=""form-control company-filter-list"">
                            <option");
            BeginWriteAttribute("value", " value=\"", 22609, "\"", 22628, 1);
#nullable restore
#line 391 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
WriteAttributeValue("", 22617, Guid.Empty, 22617, 11, false);
            ...
            WriteLiteral(@">Choose your company...</option>
                    ...
                    <div class=""form-row"">
                        ...
                        <select class=""form-control position-filter-list"">
                            <option");
            BeginWriteAttribute("value", " value=\"", 22949, "\"", 22968, 1);
#nullable restore
#line 398 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
WriteAttributeValue("", 22957, Guid.Empty, 22957, 11, false);
...
");
#nullable restore
#line 515 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisements.cshtml"
    }
